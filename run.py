# Track score and save user email for login, store
# score and user information on external sheet
...
for i in range(100):
    ...
    if len(ship_sunk_2) == 17:
        ...
        print(enemy)
        print(f'{spacer*10}All of your ships have been destroyed. You lose this battle!')
